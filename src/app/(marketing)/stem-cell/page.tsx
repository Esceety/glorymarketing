    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 w-full h-full flex items-center justify-center py-6">
          <div className="w-full max-w-5xl px-6 sm:px-8 lg:px-12 py-6 text-center">
            ...
            <p className="text-xl sm:text-2xl font-semibold mb-6 text-cyan-100">
              Now Legal in Florida — Bone Marrow, Umbilical & Exosome Stem Cell Therapy
            </p>
            ...
            <p className="text-base sm:text-lg leading-relaxed mb-8 text-gray-100 max-w-3xl mx-auto">
              If knee, hip, neck, lower back, shoulder, elbow, or joint pain is limiting your
              mobility and quality of life, stem cell therapy offers a{' '}
            ...
            >
              ...
              <p className="text-base sm:text-lg leading-relaxed mb-4">
                ...
                to help more people discover if this innovative treatment is right for
                them.
              </p>
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-blue max-w-none">
                  <p className="text-lg font-semibold text-gray-900 mb-3 italic leading-relaxed">
                    ...
                    approved by the United States Food and Drug Administration. You are encouraged
                  ...
                  <div className="bg-white rounded-lg p-4 border" style={{ borderColor: 'rgba(7, 138, 173, 0.3)' }}>
                    ...
                    <p className="text-gray-700 text-base leading-relaxed mb-3">
                      House Bill 1617 (2025) authorizes licensed physicians in Florida to perform
                      certain stem cell therapies for orthopedic, wound care, and pain management
                      applications.
                    </p>
                    ...
                    <p className="text-sm text-gray-600 mt-3">
                      *Excluding fat-derived stem cell therapy, embryonic and fetal stem cell
                      therapy
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto">
            Stem cell therapy is specifically approved for orthopedic cases involving joint,
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {[
            { icon: '🦵', title: 'Knee Pain', desc: 'Arthritis, meniscus tears, ligament injuries' },
            { icon: '🦴', title: 'Hip Pain', desc: 'Hip arthritis, bursitis, labral tears' },
            { icon: '🫱', title: 'Shoulder Pain', desc: 'Rotator cuff injuries, frozen shoulder' },
            { icon: '💪', title: 'Elbow Pain', desc: 'Tennis elbow, golfer\'s elbow, tendonitis' },
            { icon: '🧍', title: 'Back Pain', desc: 'Lower back pain, disc degeneration' },
            { icon: '🧑', title: 'Neck Pain', desc: 'Cervical disc issues, chronic neck pain' },
          ].map((condition, idx) => (
            <div
              key={idx}
      ...
      <section className="py-16 bg-gray-50">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            FDA-Certified, State-of-the-Art Facilities
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto">
            All stem cells are manufactured in FDA-certified clean room environments with
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our physicians are fully licensed and comply with Florida House Bill 1617
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Accredited Facilities</h3>
                <p className="text-gray-600 leading-relaxed">
                  FDA-registered facilities accredited by recognized organizations including the
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Full transparency with written notices and comprehensive consent procedures as
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Every treatment plan is customized to your specific condition, health history,
                  and recovery goals.
                </p>
              </div>
            </div>
