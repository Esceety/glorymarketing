...
export const metadata: Metadata = {
  title: 'Weight Loss Program Tampa - 50% Off First Month | Glory Regenerative',
  description:
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-pink-50">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 lg:pr-8">
              ...
              <div className="grid grid-cols-3 gap-4 py-4">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-pink-600">12wk</div>
                  <div className="text-base text-gray-600 mt-1">
                    Program Length
                  </div>
                </div>
                <div className="text-center">
                  ...
                  <div className="text-base text-gray-600 mt-1">Supervised</div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl p-6 text-white shadow-2xl">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-base font-semibold uppercase tracking-wide mb-2 opacity-90">
                      Limited Time Offer
                    </div>
                    ...
                    <BookingButton
                      ...
                      className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 bg-white text-purple-700 font-bold text-lg rounded-xl hover:bg-purple-50 transition-all shadow-lg hover:shadow-xl hover:scale-105 duration-200"
                    >
                      Claim Your Offer →
                    </BookingButton>
                  </div>
            ...
            <div className="relative lg:h-[600px] h-[400px] rounded-3xl overflow-hidden shadow-2xl">
              {/* Dark overlay to enhance image depth */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-black/10 to-transparent z-10" />
              <Image
                src="/images/weight-loss-hero3.jpg"
                alt="Medical Weight Loss Success"
                fill
                className="object-cover brightness-90 contrast-110 saturate-120"
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="inline-block px-4 py-1 bg-purple-100 text-purple-700 rounded-full text-base font-semibold mb-4">
              SIMPLE PROCESS
            </span>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
            ...
            <div className="relative group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 h-full">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Comprehensive health assessment with a board-certified
                  physician to create your personalized weight loss plan.
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 h-full">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Start your customized program with FDA-approved medications,
                  nutrition coaching, and weekly support.
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-purple-200 h-full">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Watch the pounds melt away with continuous monitoring,
                  adjustments, and ongoing medical support.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-b from-purple-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="inline-block px-4 py-1 bg-pink-100 text-pink-700 rounded-full text-base font-semibold mb-4">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-xl text-gray-600">
              A complete medical weight loss solution designed for lasting
              results
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-2xl p-6 border border-purple-100 hover:shadow-xl transition-shadow">
              ...
              <p className="text-base text-gray-600 leading-relaxed">
                Board-certified doctors monitor your progress every step of the
                way
              </p>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="inline-block px-4 py-1 bg-green-100 text-green-700 rounded-full text-base font-semibold mb-4">
              SUCCESS STORIES
            </span>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
        ...
        <div className="container max-w-4xl mx-auto px-4 text-center relative z-10">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 sm:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="bg-white rounded-2xl p-6 mb-8 max-w-md mx-auto shadow-xl">
              <div className="text-base font-bold text-purple-600 uppercase tracking-wide mb-2">
                Limited Time Offer
              </div>
              <div className="text-6xl sm:text-7xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
                50% OFF
              </div>
            ...
            <BookingButton
              formId="wz9f6DHcnCdzO5C7vX0x"
              className="inline-flex items-center justify-center px-12 py-6 bg-white text-purple-700 font-black text-xl rounded-2xl hover:bg-purple-50 transition-all shadow-2xl hover:shadow-3xl hover:scale-105 duration-200 group"
            >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-white/90 text-base">
              <span className="flex items-center gap-2">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
