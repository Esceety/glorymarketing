...
This special assessment includes a full health history consultation, evaluation, and a personalized treatment plan — all for just $100 (regularly $450).

If pain is interfering with your daily activities, this may be an opportunity to explore a long-lasting, non-surgical approach to pain relief.

⚠️ Only 40 vouchers available for a limited time.`,
    headline: '40 Pain Relief Vouchers Available – Limited Time',
    description: 'Assessment covers knee, hip, neck, lower back & joint pain',
    ctaText: 'Learn More',
